...
function AboutUs() {
    return (
        <div className="about-container">
            <h1>O nas</h1>
            <p>Szukasz sprawdzonego elektryka z Białegostoku, który zna się na swojej pracy i zagwarantuje dobrze wykonane zlecenie? Mogę Ci pomóc! 
            ELKAM ELECTRIC to firma, która wykonuje usługi elektryczne w Białymstoku i województwie podlaskim od 2019 roku. 
