...
import img1 from "../../../src/assets/8montazpanelifotowol/panele1.webp";
import img2 from "../../../src/assets/8montazpanelifotowol/panele2.webp";
...
function PaneleFoto() {
  return (
    <>
      <Navbar />
      <ServiceOne
        title="Montaż odnawialnych źródeł energii "
