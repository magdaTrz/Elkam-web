  ...
  return (
    <>
      <div className="heading">
        ...
        <p>
          Jeżeli masz jakiekolwiek pytania dotyczące naszej oferty oraz
          świadczonych przez nas usług – skontaktuj się z nami.
        </p>
      </div>
      <div className="form-container">
        ...
        <form
          action="https://formsubmit.co/biuro@elkamelectric.pl"
          method="POST"
        >
          ...
          <input
            type="hidden"
            name="_next"
            value="https://elkamelectric.pl/thankYou"
          />
